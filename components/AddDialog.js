...
export default function AddDialog(props) {
    ...
    return (
        <div class="inline-block align-bottom bg-white rounded-lg w-3/6 m-auto text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full p-5" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <div>
                ...
                <form className="flex-col flex" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <row className="mt-3 flex justify-end">
                        ...
                        <button className="bg-green-500 p-2 border rounded-lg text-white">Cancel</button>
                        <button type="submit" className="bg-green-500 p-2 border rounded-lg text-white">Submit</button>
